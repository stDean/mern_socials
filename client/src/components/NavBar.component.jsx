          ...
          <FlexBetween gap="2rem">
            ...
            <FormControl variant="standard" value={fullName}>
              ...
              >
                ...
                <MenuItem onClick={() => dispatch(SET_LOGOUT())}>Log Out</MenuItem>
              </Select>
            </FormControl>
          </FlexBetween>
        ) : (
          <IconButton
            onClick={() => setIsMobileMenuToggled(isMobileMenuToggled => !isMobileMenuToggled)}
          >
            <Menu />
          </IconButton>
        )
            ...
            >
              ...
              <FormControl variant="standard" value={fullName}>
                ...
                >
                  ...
                  <MenuItem onClick={() => dispatch(SET_LOGOUT())}>
                    Log Out
                  </MenuItem>
                </Select>
              </FormControl>
