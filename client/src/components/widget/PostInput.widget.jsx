...
import {
  EditOutlined, DeleteOutlined, AttachFileOutlined, GifBoxOutlined,
...
const PostInputWidget = ({ picturePath }) => {

  const dispatch = useDispatch();
  const { user: { _id }, token } = useSelector(({ auth }) => auth);
...
export default PostInputWidget